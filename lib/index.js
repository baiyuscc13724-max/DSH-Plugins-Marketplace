...
/**
 * 静态索引 registry.json 的候选源（按序尝试，全部失败才回退搜索 API）：
...
const REGISTRY_SOURCES = [
  { url: "https://api.github.com/repos/bradeGithub/DSH-Plugins-Marketplace/contents/registry.json", acceptRaw: true },
  { url: "https://cdn.jsdelivr.net/gh/bradeGithub/DSH-Plugins-Marketplace@main/registry.json", checkFresh: true },
...
export { apply, detectInstalled, loadOwnRepo, scanProfilePackages, langOf, t, fetchAllRepos, fetchRegistryRepos, isTrustedRequest, compareVersions, hasPatchEntry, normalizeRepo, appendPatchEntry, readLifecycleScripts, sanitizeManifest, isPnpmLocalDependency, matchProfileEntry, normalizeRepoRef, loadOfficialPackages, isOfficialPackage, readPackageSummary };